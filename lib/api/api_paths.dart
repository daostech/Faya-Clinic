...
class APIPath {
  ...
  static String subSectionsListBySectionId(String? sectionId) => '${AppConfig.API_ENDPATH}SubSection/$sectionId/list';
  static String subSectionsList() => '${AppConfig.API_ENDPATH}SubSection/list';
  ...
  static String clinicWorksList() => '${AppConfig.API_ENDPATH}ourWorks/list';
  static String clinicWorksListById(String sectionId) => '${AppConfig.API_ENDPATH}ourWorks/$sectionId/list';
}
